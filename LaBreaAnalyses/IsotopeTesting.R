...
#Jessica - I know lines 12-34 are redundant for your model, 
#I did it to compare "mean.d18O" and "matchedDF" datasets starting at line 193
#Im sure there's a more elegant way to do this, but I don't know how
...
allAges_d18O<-allAges_d18O[allAges_d18O$probability != 0, ]
...
#merge(matchedDF, mean.d18O, by=number, all=TRUE)
#
library(dplyr)
library(stringr)
